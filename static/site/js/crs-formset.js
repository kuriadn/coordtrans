(function () {
  ...
  function initFormset(containerId, addBtnId, totalFormsId, emptyTemplateId) {
    ...
    addBtn.addEventListener('click', function () {
      ...
      container.insertAdjacentHTML('beforeend', emptyTemplate.innerHTML.replace(/__prefix__/g, String(count)));
      totalInput.value = String(count + 1);
    });
  }

  document.addEventListener('DOMContentLoaded', function () {
    initFormset('crs_form_set', 'crs_add_point', 'id_pts-TOTAL_FORMS', 'crs_empty_form');
  });
})();
